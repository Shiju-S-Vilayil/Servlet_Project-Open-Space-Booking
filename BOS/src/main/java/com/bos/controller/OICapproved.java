...
/**
 * Servlet implementation class OICapproved
 */
@WebServlet("/OICapproved")
public class OICapproved extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(roleid!=null)
		{
			...
			try {
				...
				out.println("\t\t\t</li>");
				out.println("\t\t\t<li>");
				out.println("\t\t\t<li class='OICapproved'>");
				out.println("\t\t\t\t<a href='#'>");
				...
				out.println("<h5 style='color:#008080'>Approved Request</h5>");
				 out.println("    <div class='container'>");
		            ...
		            out.println("      <tbody>");
			            try 
			            {
			            	String sql="select * from seatreserved where booking_status=1";
			            	...
			            	while(rs.next())
			            	{
			            		 out.println("       <tr>");
					                ...
					                {
					                	out.println(" <td><span style='color:green'>Approved<span></td>");
					                }
